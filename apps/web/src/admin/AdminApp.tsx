...
function useCrumbs(t:(k:string)=>string, base:string) {
  ...
  return useMemo(() => {
    ...
    const map: Record<string,string> = { overview:t('nav.overview'), equipment:t('nav.equipment'), inquiry:t('nav.inquiry'), settings:t('nav.settings'), new:t('topbar.new'), edit:t('topbar.edit'), import:t('topbar.import') };
